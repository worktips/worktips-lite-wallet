...
const char COMMUNITY_FORUM_URL[] = "https://discord.gg/YGeWXQ2";
const char REPORT_ISSUE_URL[] = "https://discord.gg/YGeWXQ2";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Worktips Lite Wallet v1.0.2.3"));
